...
export default function MediaEditor({mediaId, attachToEntity, onCancel, onMediaAttached}) {
        ...
        <div className="w-full max-w-4xl mx-auto space-y-6">
            ...
            <div
                ...
                style={{
                    ...
                    backgroundColor: isDragActive ? 'var(--color-surface)' : 'transparent',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {media ? (
                        <div className="rounded-lg p-4" style={{
                            ...
                            <MyForm
                                ...
                                additionalButtons={hasUnsavedChanges ? [
                                    {
                                        label: "Annuler",
                                        type: "button",
                                        style: {
                ...
                <div>
                    ...
                    {allMedia.length === 0 ? (
                        <p style={{color: 'var(--color-text-muted)'}}>Aucun média disponible</p>
                    ) : (
                        <div className="grid grid-cols-2 gap-3 max-h-96 overflow-y-auto">
                            {allMedia.map((m) => (
                                ...
                                >
                                    ...
                                    />
                                    <p className="text-xs mt-1 truncate" style={{color: 'var(--color-text)'}}>
                                        {m.title || "Sans titre"}
                                    </p>
                                </div>
                            ))}
