    ...
    if (loading) {
        return (
            <div className="text-center py-8">
                <div
                    className="inline-block animate-spin rounded-full h-8 w-8 border-4 border-gray-200 border-t-indigo-600"></div>
        ...
        <div className="w-full space-y-6">
            ...
            <div>
                ...
                <MyForm
                    ...
                    submitButtonLabel={hasUnsavedChanges ? "Enregistrer et utiliser" : "Utiliser cette image"}
                    allowNoChanges={true}
                />
            </div>
