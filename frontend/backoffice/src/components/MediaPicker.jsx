...
export default function MediaPicker({mediaId, attachToEntity, entityType = "pages", entityId}) {
    ...
    return (
        <div className="mt-6">
            <span className="mb-1 font-medium" style={{color: 'var(--color-text)'}}>Bannière</span>
            {selectedMedia ? (
