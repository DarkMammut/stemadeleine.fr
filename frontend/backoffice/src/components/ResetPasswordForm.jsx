                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-xl">
                    <div className="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
                        <div className="p-4 rounded-md bg-red-50 border border-red-200">
                            <p className="text-sm text-red-800">{error || "Ce lien est invalide ou a expiré"}</p>
                        </div>
                        <p className="mt-4 text-sm text-gray-600">
                            Le lien de réinitialisation est peut-être expiré (durée de validité : 1 heure).
                            Vous pouvez demander un nouveau lien.
                        </p>
                        <div className="mt-6 space-y-3">
                            <Link
                                href="/auth/forgot-password"
                                className="block w-full text-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500"
                            >
                                Demander un nouveau lien
                            </Link>
                            <Link
                                href="/auth/login"
                                className="block w-full text-center text-sm font-semibold text-indigo-600 hover:text-indigo-500"
                            >
