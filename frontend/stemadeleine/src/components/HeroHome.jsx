...
export default function HeroHome({ mediaId, title, subtitle }) {
  ...
  return (
    ...
    >
      {/* Overlay foncé léger */}
      <div className="absolute inset-0 bg-primary-light"></div>

      {/* Encadrement flouté */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div
          className="bg-primary/30 backdrop-blur-md rounded-lg px-10 py-8 text-center text-gray-900 shadow-xl max-w-2xl">
          {title && (
