        ...
        <>
            ...
            <div className="bg-primary pt-8 pb-24 sm:pt-10 sm:pb-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div
                        className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base/7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        <div>
                            <h3 className="border-l border-secondary-600 pl-6 font-semibold text-secondary">
                                Association
                            </h3>
                            <address className="border-l border-gray-200 pt-2 pl-6 text-secondary-light not-italic">
            ...
            <div className="relative bg-cream pt-8 pb-24 sm:pt-10 sm:pb-32">
