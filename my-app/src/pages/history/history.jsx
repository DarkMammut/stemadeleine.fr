    ...
    <main id="history">
      ...
      <section className="section">
        <article className="section__article">
          <div className="section__article__image">
            <button
              className="section__article__image__container"
              onClick={() => setOpen(1)}
              onKeyDown={handleKeyDown}
              type="button"
              tabIndex={0}>
              <img
                className="section__article__image__container__picture"
          ...
          <div className="section__article__textarea">
            <h2 className="section__article__textarea__title">samedi 30 octobre 1869</h2>
            <h3>BULLETIN RELIGIEUX DU DIOCESE DE LA ROCHELLE SAINTES</h3>
            <h4>6° année</h4>
            <h5>Extrait.</h5>
            <p className="section__article__textarea__paragraph">
