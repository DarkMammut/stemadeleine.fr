      ...
      <div className="join">
        ...
        <div>
          <p>
            ...
            facilisis. Mauris sed mi ipsum. Ut lorem ante, vulputate non nibh vitae, finibus aliquet
            dolor. Nunc mauris lorem, sagittis id magna at, sodales congue enim. Aliquam vel augue
            placerat, porta augue vitae, efficitur ligula. In condimentum at nunc a placerat.
            Suspendisse eget eros vel est ullamcorper condimentum. Praesent enim magna, consequat
            eget eros eget, egestas facilisis lacus. Sed vitae interdum nisi. Integer scelerisque,
            magna at faucibus scelerisque, diam diam convallis leo, scelerisque egestas magna neque
            eu tellus. Sed aliquet lectus non ipsum convallis, vel ultricies ante pellentesque. In
            aliquet ex et nibh vehicula pretium. Donec pulvinar nulla justo, ut vehicula eros
            sollicitudin vitae.
          </p>
